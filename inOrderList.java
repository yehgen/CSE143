// Write a method inOrderList that could be added to the IntTree class from lecture and section. The method returns a list containing the sequence of values obtained from an in-order traversal of your binary tree of integers. For example, if a variable tree refers to the following tree:
